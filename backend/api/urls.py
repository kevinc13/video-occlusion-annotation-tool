...
urlpatterns = [
     ...
     path("videos/<int:video_id>", views.VideoDetail.as_view(),
          name="video-detail"),
     path("video_flags/", views.VideoFlagList.as_view(), name="video-flag-list"),
     path("video_flags/<int:video_flag_id>", views.VideoFlagDetail.as_view(),
          name="video-flag-detail"),
